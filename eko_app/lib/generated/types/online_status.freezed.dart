...
/// Adds pattern-matching-related methods to [OnlineStatus].
extension OnlineStatusPatterns on OnlineStatus {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool online, @JsonKey(includeFromJson: false) bool valid,
            String? id, @JsonKey(name: 'last_changed') int? lastChanged)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _() when $default != null:
        return $default(_that.online, _that.valid, _that.id, _that.lastChanged);
      case _:
        return orElse();
    }
  }
