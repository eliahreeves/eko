...
final class FollowInfoProvider
  ...
  FollowInfoProvider._(
      {required FollowInfoFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class FollowInfoFamily extends $Family
    with
        $ClassFamilyOverride<FollowInfo, AsyncValue<FollowInfoModel>,
            FollowInfoModel, FutureOr<FollowInfoModel>, String> {
  FollowInfoFamily._()
      : super(
          retry: null,
          name: r'followInfoProvider',
