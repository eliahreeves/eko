...
CREATE OR REPLACE FUNCTION "public"."paginated_activites"("p_limit" integer, "p_last_time" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_last_id" bigint DEFAULT NULL::bigint) RETURNS TABLE("id" bigint, "created_at" timestamp with time zone, "source_uid" "uuid", "post_id" bigint, "comment_id" bigint, "type" "text")
    LANGUAGE "sql" STABLE
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."paginated_activites"("p_limit" integer, "p_last_time" timestamp with time zone, "p_last_id" bigint) OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."notifications"
    ADD CONSTRAINT "notifications_pkey" PRIMARY KEY ("user_uid", "token");
...
GRANT ALL ON FUNCTION "public"."paginated_activites"("p_limit" integer, "p_last_time" timestamp with time zone, "p_last_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."paginated_activites"("p_limit" integer, "p_last_time" timestamp with time zone, "p_last_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."paginated_activites"("p_limit" integer, "p_last_time" timestamp with time zone, "p_last_id" bigint) TO "service_role";
