...
class $AuthInfoTableTable extends AuthInfoTable
  ...
  late final GeneratedColumnWithTypeConverter<Uri, String> did =
      GeneratedColumn<String>('did', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
  ...
  static const VerificationMeta _actorJsonMeta =
      const VerificationMeta('actorJson');
  @override
  late final GeneratedColumn<String> actorJson = GeneratedColumn<String>(
      'actor_json', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  late final GeneratedColumnWithTypeConverter<Uri, String> serverUrl =
      GeneratedColumn<String>('server_url', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
          .withConverter<Uri>($AuthInfoTableTable.$converterserverUrl);
  @override
  List<GeneratedColumn> get $columns =>
      [id, did, accessToken, refreshToken, expiresAt, actorJson, serverUrl];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<AuthInfoTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  AuthInfoTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AuthInfoTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      did: $AuthInfoTableTable.$converterdid.fromSql(attachedDatabase
          .typeMapping
      ...
      actorJson: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}actor_json'])!,
      serverUrl: $AuthInfoTableTable.$converterserverUrl.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.string, data['${effectivePrefix}server_url'])!),
    );
  }
...
class AuthInfoTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['did'] =
          Variable<String>($AuthInfoTableTable.$converterdid.toSql(did));
    }
  ...
  factory AuthInfoTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return AuthInfoTableData(
      id: serializer.fromJson<int>(json['id']),
...
class AuthInfoTableCompanion extends UpdateCompanion<AuthInfoTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (did.present) {
      map['did'] =
          Variable<String>($AuthInfoTableTable.$converterdid.toSql(did.value));
    }
...
typedef $$UserDevicesTableProcessedTableManager = ProcessedTableManager<
    ...
    UserDevice,
    PrefetchHooks Function({bool userId})>;
typedef $$AuthInfoTableTableCreateCompanionBuilder = AuthInfoTableCompanion
    Function({
  Value<int> id,
  required Uri did,
  required String accessToken,
...
typedef $$AuthInfoTableTableUpdateCompanionBuilder = AuthInfoTableCompanion
    Function({
  Value<int> id,
  Value<Uri> did,
  Value<String> accessToken,
...
class $$AuthInfoTableTableFilterComposer
  ...
  ColumnFilters<String> get actorJson => $composableBuilder(
      column: $table.actorJson, builder: (column) => ColumnFilters(column));
...
class $$AuthInfoTableTableOrderingComposer
  ...
  ColumnOrderings<String> get actorJson => $composableBuilder(
      column: $table.actorJson, builder: (column) => ColumnOrderings(column));
...
class $$AuthInfoTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    $AuthInfoTableTable,
    AuthInfoTableData,
    $$AuthInfoTableTableFilterComposer,
...
typedef $$AuthInfoTableTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $AuthInfoTableTable,
    AuthInfoTableData,
    $$AuthInfoTableTableFilterComposer,
