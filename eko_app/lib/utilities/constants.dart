...
const lightThemeColors = ColorScheme(
  ...
  onErrorContainer: Color(0xFFFEFEFE),
...
const int maxPostChars = 1000;
const int maxCommentChars = 500;
const int maxTitleChars = 200;
const int minPollOptions = 2;
const int maxPollOptions = 6;
...
const int postsOnRefresh = 15;
const int usersOnSearch = 20;
const int activitiesPerRequest = 20;
