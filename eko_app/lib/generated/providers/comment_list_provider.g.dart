...
final class CommentListProvider extends $NotifierProvider<
    CommentList,
    (
      List<int>,
      bool,
  ...
  CommentListProvider._(
      {required CommentListFamily super.from, required int super.argument})
      : super(
          retry: null,
...
abstract class _$CommentList extends $Notifier<
    (
      List<int>,
      bool,
    )> {
